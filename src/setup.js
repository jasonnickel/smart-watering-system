...
// Writes ~/.smart-water/.env and zones.yaml.
...
const ENV_DIR = join(homedir(), '.smart-water');
...
export async function runSetup() {
  console.log(`\n${BOLD}Smart Water System - Setup Wizard${RESET}\n`);
  ...
  console.log(`  1. Run ${BOLD}smart-water doctor${RESET} to verify connectivity`);
  console.log(`  2. Run ${BOLD}smart-water run --shadow${RESET} to test a decision cycle`);
  console.log(`  3. Edit ${BOLD}zones.yaml${RESET} if your zone layout differs from defaults`);
  console.log(`  4. After a week of shadow runs, run ${BOLD}smart-water go-live${RESET}`);
  console.log('');
