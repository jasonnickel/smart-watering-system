...
export function currentNotice(query) {
  ...
  const notices = {
    ...
    'settings-saved': { tone: 'success', text: 'Settings saved. Credential and location changes take effect immediately. Restart the web UI only if you changed the host or port.' },
